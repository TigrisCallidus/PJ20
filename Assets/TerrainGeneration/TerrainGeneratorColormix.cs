...
public class TerrainGeneratorColormix : MonoBehaviour {
    ...
    public int CalculateGradient(Vector3 vertex) {
        int returnValue = 0;
        ...
        int x = Mathf.RoundToInt(posX * TerritoryDistribution.width);
        int z = Mathf.RoundToInt(posZ * TerritoryDistribution.height);


        Color color = TerritoryDistribution.GetPixel(x, z);
    ...
    public void SaveSettings() {
        ...
        UsedProfile.HeighGradient = HeighGradient0;
    ...
    public void LoadSettings() {
        ...
        HeighGradient0 = UsedProfile.HeighGradient;
